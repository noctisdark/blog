...
description: "StrongSwan est une solution de passerelle VPN IPsec à code source ouvert utilisée pour les communications sécurisées entre sites distants ou pour l'accès à distance au VPN. Hautement configurable et flexible, elle prend en charge divers algorithmes cryptographiques, protocoles d'échange de clés et méthodes d'authentification."
...
language: "french"
image: "https://www.strongswan.org/images/strongswan_square_large.png"
...
Il y a sans doute plusieurs solutions valides. **_J'aimerai savoir laquelle est "good practice" et pourquoi s'il vous plaît_**.
