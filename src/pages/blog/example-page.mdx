...
import CodeTabs from "@components/ui/blog/CodeTabs.tsx";

{/* TODO MENU OBJECT */}

## Random

<CodeTabs activeTab="One.js">
  <Fragment slot="One.js">
    ```javascript 
      console.log("One!");
    ```
  </Fragment>
   <Fragment slot="OneOne.js">
    ```javascript 
      console.log("OneOne !");
    ```
  </Fragment>
   <Fragment slot="OneOneOne.js">
    ```javascript 
      console.log("OneOneOne !");
    ```
  </Fragment>
   <Fragment slot="OneOneOneOne.js">
    ```javascript 
      console.log("OneOneOneOne !");
    ```
  </Fragment>
   <Fragment slot="OneOneOneOneOne.js">
    ```javascript 
      console.log("OneOneOneOneOne !");
    ```
  </Fragment>

  <Fragment slot="server.js">
    ```javascript    
/**
 * Module dependencies.
 */
