...
This doesn't mean what the solutions we get by solving these inequalities are characters of the flag, but characters of the flag is among the solutions for sure.
...
for quad in equations:
  ...
  # We don't know which cody will satisfy this equation, but one of them will
...
This method is really fast for finding the *unique* flag but it's not general (*issues include: 2 doubles, lack of actual constraint satisfaction, etc..*)
