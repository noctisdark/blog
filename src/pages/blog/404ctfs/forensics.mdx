...
description: "404CTF Challenges in the Forensics category."
author: "Majed Abdennadher"
timestamp: 1690703491953
duration: 10
tag: "404CTF"
slug: "forensics"
language: "english"
...
We can then use `stegsolve` (*instructions in another blog post [here](/blog/404ctfs/stegano/#l%C5%93uvre)*). 
...
At first I tried if I can get the flag for free with it:
...
*[This](https://cyberarms.wordpress.com/2011/11/04/memory-forensics-how-to-pull-passwords-from-a-memory-dump/) is one of the first articles I read about using the tool and also happens to be a good Introduction.*
